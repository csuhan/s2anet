...
from mmdet.core import (auto_fp16, bbox_target, delta2bbox, force_fp32,
                        multiclass_nms,delta2rbox,multiclass_nms_rbox,
                        poly2rbox_torch,poly2rbox,rect2rbox)
...
class RBBoxHead(nn.Module):
    ...
    def loss(self,
        ...
        pos_inds = labels > 0
        if bbox_pred is not None and bbox_pred[pos_inds].shape[0]>0:
            ...
            # print(bbox_targets[pos_inds].shape)
            # print('---------')
    ...
    def get_det_bboxes(self,
        ...
        if cfg is None:
            ...
            det_bboxes, det_labels = multiclass_nms_rbox(bboxes, scores,
