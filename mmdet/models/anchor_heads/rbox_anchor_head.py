...
class RBoxAnchorHead(nn.Module):
    ...
    def __init__(self,
        ...
        super(RBoxAnchorHead, self).__init__()
    ...
    def get_bboxes_single(self,
        ...
        for cls_score, bbox_pred, anchors in zip(cls_score_list,
            ...
            bboxes = delta2rbox(rbox_anchors, bbox_pred, self.target_means,
        ...
        det_bboxes, det_labels = multiclass_ml_nms_rbox(mlvl_bboxes, mlvl_scores,
